...
_O script `db/init.sh` será executado automaticamente pelo container para criar a estrutura e carregar os dados iniciais._ 
...
_Este projeto utiliza Geometrias (Point, LineString, Polygon) com o SRID 4326 (WGS84) para representação geográfica dos ativos._
